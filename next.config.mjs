        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://openrouter.ai https://api.openai.com https://api.z.ai https://generativelanguage.googleapis.com https://cloud.umami.is https://api-gateway.umami.dev https://api.jsonbin.io",
